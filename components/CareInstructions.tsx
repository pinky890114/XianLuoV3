...
const CareInstructions: React.FC = () => (
    <div className="w-full min-w-0 space-y-4 border-2 border-dashed border-siam-brown/40 rounded-lg p-4 bg-siam-brown/5 mt-4 text-sm md:text-base">
        <h3 className="font-bold text-lg mb-2 text-siam-dark flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
            養護指南
        </h3>
        <ul className="list-disc list-outside pl-5 space-y-2 text-siam-brown break-words">
